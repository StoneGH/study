...
/**
 * 
 * <p>Class Name: MD5Util</p>
 * <p>Description: MD5工具类，提供字符串MD5加密（校验）、文件MD5值获取（校验）功能  </p>
...
public class MD5Util {
	...
	public static String getMD5String(String str) {
		//System.out.println(getMD5String(str.getBytes()));
		return getMD5String(str.getBytes());
	}

	/**
	 * 
	 * 描述: MD5加密以byte数组表示的字符串
